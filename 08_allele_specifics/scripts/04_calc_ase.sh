...
BAM=/gpfs/projects/bsc83/Projects/pantranscriptome/pclavell/08_allele_specifics/data/02_haplotype_alignments/${SAMPLENAME}_preprocessed_Q7_reads_aln_sorted.merged.bam
VCF=data/01_samples_vcf/${KGCODE}_het.vcf.gz
OUTPUT=data/04_calc_ase/${SAMPLENAME}_ase.tsv

mkdir -p data/04_calc_ase

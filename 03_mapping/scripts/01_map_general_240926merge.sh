...
INPUTFASTQ=$1
TYPE=240926merge_general_mapping
JUNCBED=/gpfs/projects/bsc83/Projects/pantranscriptome/novelannotations/merged/240926_filtered_with_genes.bed
...
mkdir -p data/$TYPE/genomic
mkdir -p data/$TYPE/sirv
